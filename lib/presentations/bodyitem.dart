                  ...
                  Row(
                    children: [
                      Text(
                        "Pancake & Cream",
                        style: TextStyle(
                          color: CategoryApp.containertextcolor,
...
class Containers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 81,
      decoration: BoxDecoration(
        color: CategoryApp.ingredientcontainer1,
        borderRadius: BorderRadius.circular(14),
      ),
      child: Text(text,
        style: TextStyle(
          color: CategoryApp.ingredienttextcolor,
          fontWeight: FontWeight.bold,
          fontSize: 15,
        ),
      ),
...
class Containertwo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: 81,
      decoration: BoxDecoration(
        color: CategoryApp.ingredientcontainer2,
        borderRadius: BorderRadius.circular(14),
      ),
      child: Text(text,
        style: TextStyle(
